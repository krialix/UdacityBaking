package com.udacity.udacitybaking.recipelist;
...
import com.udacity.udacitybaking.recipedetail.RecipeDetailActivity;
import com.udacity.udacitybaking.recipedetail.RecipeDetailFragment;
...
public class RecipeListActivity extends AppCompatActivity {
  ...
  public static class SimpleItemRecyclerViewAdapter
    ...
    SimpleItemRecyclerViewAdapter(
        RecipeListActivity parent, List<DummyContent.DummyItem> items, boolean twoPane) {
      mValues = items;
